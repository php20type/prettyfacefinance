                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td bgcolor="#eeeeee" style="padding: 60px 40px 60px 40px;">
                                This email is to remind that the insurance of the {{ $clinicDetails['name'] }} is going
                                to get
                                expired on date {{ $expiryDate }}. Kindly request them to renew the insurance in order
                                to
