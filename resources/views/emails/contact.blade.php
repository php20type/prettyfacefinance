                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td bgcolor="#eeeeee" style="padding: 60px 40px 60px 40px;">
                                Thank you for registering with Cosmetic Finance Group. It may take up to two weeks to
                                activate your account.<br><br>

                                If you have any questions, please <a style="color: #B29961;"
                                    href="mailto: info@cosmeticfinancegroup.co.uk">contact us.</a>
                            </td>
                        </tr>
                        <tr>
