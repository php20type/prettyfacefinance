                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td bgcolor="#eeeeee" style="padding: 60px 40px 60px 40px;">
                                Company Details Form has been filled by this clinic
                                <strong>{{ $clinicModel->name }}</strong><br><br>

                                To view the notification, please visit your account <a style="color: #B29961;"
                                    href="http://cosmeticfinancegroup.co.uk/login">here.</a>
                            </td>
                        </tr>
                        <tr>
