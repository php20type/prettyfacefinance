                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="600">
                        <tr>
                            <td bgcolor="#343a40" align="center" style="padding: 20px 20px 20px 20px;">
                                <img src="{{ asset('new_css/img/logo/logo.png') }}" alt="" style="width: 160px;">
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#eeeeee" style="padding: 60px 40px 60px 40px;">
                                You have received a new notification at cosmeticfinancegroup.co.uk<br><br>

                                To view the notification, please visit your account <a style="color: #B29961;" href="http://cosmeticfinancegroup.co.uk/login">here.</a>
                            </td>
                        </tr>
                        <tr>
