...
@section('content')
    <div class="container">
                ...
                <h2>
                    ...
                    @if (Auth::user()->role == 0 && $companyDetailsModel->is_approved != 1)
                        <a data-placement="bottom" data-toggle="tooltip" title="Edit"
                            href="{{ route('companydetails.edit', $companyDetailsModel->clinic_id) }}">
                            <i class="fa fa-edit"></i>
                        </a>

                        <a target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download"
                            href="{{ route('companydetails.downloadForm', $companyDetailsModel->clinic_id) }}">
                    ...
                    @if (Auth::user()->role == 1)
                        ...
                        <a data-placement="bottom" data-toggle="tooltip" title="Download"
                            href="{{ route('companydetails.downloadForm', $companyDetailsModel->clinic_id) }}">
                            <i class="fa fa-download"></i>
                        </a>

                        @if ($companyDetailsModel->is_approved == 0)
                            <a data-placement="bottom" data-toggle="tooltip" title="Approve"
                                href="{{ route('companydetails.approve', $companyDetailsModel->clinic_id) }}">
                                <i class="fa fa-check"></i>
                            </a>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#disApprove">
                                <i data-placement="bottom" data-toggle="tooltip" title="Disapprove" class="fa fa-ban"></i>
                            </a>
                        @endif
                    @endif
                </h2>
        ...
        <div class="modal fade" id="disApprove" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <form method="POST"
                                    action="{{ route('companydetails.disapprove', $companyDetailsModel->clinic_id) }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                                    <div class="form-group">
                                        <label for="description">Description</label>
                                        <textarea required name="description" id="description" cols="30" rows="6" class="form-control"></textarea>
                                    </div>
        ...
        <div class="row clinic-information">
            <div class="col-12">
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->completed_by ?? '' }}</div>
                </div>
                ...
                @if ($companyDetailsModel->owner_director_company == 0)
                    <div class="row py-3 border-bottom">
                        ...
                        <div class="col-12 col-md-6">{{ $companyDetailsModel->further_info ?? '' }}</div>
                    </div>
                @endif

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Date form completed</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->date_from_completed ?? '' }}</div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->company_name ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Company Registration Number On Companies House</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->company_registration_no ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">VAT Number (if applicable)</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->vat_no ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Other trading names (please ensure that all trading names
                        entered here are entered on the ICO Fee Payers Register)</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->other_trading_name ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Company Address (please provide trading address also if
                        this is different to the registered address of the company)</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->company_address ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Main Telephone</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->main_telephone ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Clinic Telephone Number (If applicable)</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->clinic_telephone_no ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Email Address</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->email_address ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Please provide your website(s) URL(s), Facebook page URL
                        and details of names/handles on any other social media platform you use (Twitter, Instagram etc.)
                    </div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->website_url ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Please describe the activities that the company carries
                        out.</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->company_activities ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Expected volumes from finance clients over the next 12
                        months.
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Are you a member of a trade body or hold a professional
                ...
                @if ($companyDetailsModel->member_of_trade_body == 1)
                    <div class="row py-3 border-bottom">
                        ...
                        <div class="col-12 col-md-6">{{ $companyDetailsModel->registration_no ?? '' }}</div>
                    </div>
                @else
                    <div class="row py-3 border-bottom">
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Are you an Appointed Representative for any other FCA
                        authorised company? If so, please provide the name and the activities that you carry out for it and
                ...
                @if ($companyDetailsModel->appointed_representative == 1)
                    <div class="row py-3 border-bottom">
                        ...
                        <div class="col-12 col-md-6">{{ $companyDetailsModel->frn_number ?? '' }}</div>
                    </div>
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">If you have an existing Principal, have you notified the
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">If you have an existing Principal, will you continue to
                        be
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Do you intend to make an application to the FCA for direct authorisation for the activity for which
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Have there been any discliplinary action by the FCA, ICO or any regulatory body in the last 5 years
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Please confirm that you do/will have in place processes to verify the integrity and competency of
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Do you intend to use any other third parties to carry out all or part of the services? If so, please
                        give details
                    </div>
                    <div class="col-12 col-md-6">
                ...
                @if ($companyDetailsModel->carry_out_all == 1)
                    <div class="row py-3 border-bottom">
                        <div class="col-12 col-md-6 font-weight-bold">Further Information</div>
                        <div class="col-12 col-md-6">{{ $companyDetailsModel->carry_out_all_firther_info ?? '' }}</div>
                    </div>
                @endif

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Does your company work alongside any third party companies ? (If yes we will require some further
                        information)
                    </div>
                    <div class="col-12 col-md-6">
                ...
                @if ($companyDetailsModel->work_with_third_party_company == 1)
                    <div class="row py-3 border-bottom">
                        <div class="col-12 col-md-6 font-weight-bold">Further Information</div>
                        <div class="col-12 col-md-6">{{ $companyDetailsModel->further_information ?? '' }}</div>
                    </div>
                @endif
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        If your customers receive communications or marketing about your business, have you acquired valid
                        consent?
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Will any customer data be transferred outside the UK? If yes, how do you ensure that you comply with
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Please describe how will you obtain customers? (i.e. via
                        outbound calls, online, adverts, social media such as Facebook, Messenger etc</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->obtain_customers ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        In line with treating customers fairly you must keep all of your prices the same regardless of the
                        clients chosen payment method. This means you are not allowed to charge more for treatments/training
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Has any Director of the Company or a senior Manager in the last five years been the subject matter
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">
                        Do you consent to CFG carrying out audits, which may include but are not limited to visits to your
                        site(s), access to customer communications, data consents and/or call recordings and financial data
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Please confirm if requested that you will provide on a
                        monthly basis report which will include:</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->monthly_basis_report ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Please provide any further information you think will be
                        helpful.</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->further_information_box_opposite ?? '' }}</div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->name ?? '' }}</div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->signature != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->signature) }}" target="_blank">View
                                File</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->position ?? '' }}</div>
                </div>

                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Date</div>
                    <div class="col-12 col-md-6">{{ $companyDetailsModel->date ?? '' }}</div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->id_proof != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->id_proof) }}" target="_blank">View
                                File</a>
                        @endif
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Proof of personal ( home ) address / utility bill (less
                        than 3 months old)
                    </div>
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->address_proff != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->address_proff) }}" target="_blank">View
                                File</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="row py-3 border-bottom">
                    <div class="col-12 col-md-6 font-weight-bold">Bank Account of the business - business account or
                        trading account
                    </div>
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->bank_account_proof != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->bank_account_proof) }}"
                                target="_blank">View
                                File</a>
                        @endif
                    </div>
                ...
                <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->photo_of_working_space != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->photo_of_working_space) }}"
                                target="_blank">View
                                File</a>
                        @endif
                    </div>
                ...
                {{-- <div class="row py-3 border-bottom">
                    ...
                    <div class="col-12 col-md-6">
                        @if ($companyDetailsModel->logo != '')
                            <a href="{{ asset('uploads/' . $companyDetailsModel->logo) }}" target="_blank">View
                                File</a>
                        @endif
                    </div>
                </div> --}}
